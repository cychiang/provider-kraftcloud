...
PROJECT_REPO ?= github.com/cychiang/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.2.1

export TERRAFORM_PROVIDER_SOURCE ?= kraftcloud/kraftcloud
export TERRAFORM_PROVIDER_REPO ?= https://github.com/kraftcloud/terraform-provider-kraftcloud
export TERRAFORM_PROVIDER_VERSION ?= 0.1.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= kraftcloud/kraftcloud
